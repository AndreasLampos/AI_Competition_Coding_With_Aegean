...
if __name__ == "__main__":
    # For full model training on all data (if needed)
    ...
    if flight_type == FlightType.DOMESTIC:
        ...
        # For interactive prediction on international flights using full-data model:
        ...
        print("Interactive international prediction not implemented in simulation mode.")